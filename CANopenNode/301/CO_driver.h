 ...
 *  Same as 11-bit addresses of CAN messages.
 *  These are default identifiers and can be changed in CANopen.
 *  Especially PDO identifiers are configured in PDO linking phase of the CANopen network configuration.
 *
 *
 */
